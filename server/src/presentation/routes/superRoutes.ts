...
router.get("/revenue/subscription", superController.revenuSubscription.bind(superController))
router.get("/user/growth", superController.UserGrowthChart.bind(superController))
